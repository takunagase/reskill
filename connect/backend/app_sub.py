...
def run_gpt():
    ...
    try:
        ...
        request_to_gpt = "私の職歴は"+  career_l1 + "・" + career_s1 + "を" +  str(career_length1) + "年と" +  career_l2 + "・" + career_s2 + "を" +  str(career_length2) +"年経験しています。まず、【現状のあなたのスキル】と題して役職や職歴・資格から推察されるスキルをMECEに因数分解して、理由とともに具体的に出力してください。次に【お勧めの掛け合わせスキル】と題して、現在の職歴や提示してもらったスキルからは大きく逸脱するが、掛け合わせることで新たな視点やアプローチをもたらす可能性のある異分野のスキルをなるべく数多く示してください。まずは500文字以内でお願いします。"
        # 保有資格は"+ skill_s1 + "・" + skill_s2 + "です。
